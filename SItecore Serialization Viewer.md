I want to leverage Sitecore CLI serialization extensions to build a VSCode Extension, in special the commands: dotnet sitecore ser info and dotnet sitecore ser explain -p "/sitecore/content/some/path" To build a tool that helps Developers (locally) to visualize the Sitecore Content Tree and quickly see if items are serialized, where and how. --- Example of Info output: PS D:\Git\Client\dxp-sitecoreai> dotnet sitecore ser info Maximum subtree-relative item path allowed: 100 nextjs-starter Subtrees: DefaultRenderingHost: /sitecore/system/Settings/Services/Rendering Hosts/Default Scope: SingleItem FieldsFilter Excludes: 0 Roles: 0 Users: 0 Project.click-click-launch Subtrees: ccl.templates: /sitecore/templates/Project/click-click-launch ccl.templates.branches: /sitecore/templates/Branches/Project/click-click-launch ccl.modules: /sitecore/system/settings/Project/click-click-launch ccl.renderings: /sitecore/Layout/Renderings/Project/click-click-launch ccl.placeholderSettings: /sitecore/Layout/Placeholder Settings/Project/click-click-launch ccl.powershell: /sitecore/system/Modules/PowerShell/Script Library/Click Click Launch ccl.media.fd: /sitecore/media library/Feature/Alaris ccl.media.ms: /sitecore/media library/Feature/Solterra ccl.media.bp: /sitecore/media library/Feature/SYNC FieldsFilter Excludes: 0 Roles: 0 Users: 0 Client.Common Common Component items for the Client website Subtrees: System.Settings.Client.Common: /sitecore/system/Settings/Feature/Client/Components/Common Templates.Feature.Client.Common: /sitecore/templates/Feature/Client/Components/Common Templates.Branches.Client.Common: /sitecore/templates/Branches/Feature/Client/Components/Common Layout.Renderings.Client.Common: /sitecore/layout/Renderings/Feature/Client/Components/Common Layout.Placeholders.Client.Common: /sitecore/layout/Placeholder Settings/Feature/Client/Components/Common FieldsFilter Excludes: 0 Roles: 0 Users: 0 Client.Heroes Heroes Component items for the Client website Subtrees: System.Settings.Client.Heroes: /sitecore/system/Settings/Feature/Client/Components/Heroes Templates.Feature.Client.Heroes: /sitecore/templates/Feature/Client/Components/Heroes Templates.Branches.Client.Heroes: /sitecore/templates/Branches/Feature/Client/Components/Heroes Layout.Renderings.Client.Heroes: /sitecore/layout/Renderings/Feature/Client/Components/Heroes Layout.Placeholders.Client.Heroes: /sitecore/layout/Placeholder Settings/Feature/Client/Components/Heroes FieldsFilter Excludes: 0 Roles: 0 Users: 0 Client.media-full-width Items related to the Media Full Width component Subtrees: Templates.Components.MediaFullWidth: /sitecore/templates/Feature/Client/Components/Media Full Width Renderings.Components.MediaFullWidth: /sitecore/layout/Renderings/Feature/Client/Components/Media Full Width FieldsFilter Excludes: 0 Roles: 0 Users: 0 _Client.Main Foundational items for the Client website Subtrees: System.Settings.Project.Client: /sitecore/system/Settings/Project/Client System.Settings.Feature.Client: /sitecore/system/Settings/Feature/Client Scope: ItemAndChildren Templates.Project.Client: /sitecore/templates/Project/Client Scope: SingleItem Templates.Project.Client.Base: /sitecore/templates/Project/Client/Base Templates.Feature.Client: /sitecore/templates/Feature/Client Scope: ItemAndChildren Templates.Branches.Project.Client: /sitecore/templates/Branches/Project/Client Scope: SingleItem Templates.Branches.Feature.Client: /sitecore/templates/Branches/Feature/Client Scope: ItemAndChildren Media.Project.Client: /sitecore/Media Library/Project/Client Rules: 3 Layout.Renderings.Project.Client: /sitecore/layout/Renderings/Project/Client Scope: SingleItem Layout.Renderings.Feature.Client: /sitecore/layout/Renderings/Feature/Client Scope: ItemAndChildren Layout.Placeholders.Project.Client: /sitecore/layout/Placeholder Settings/Project/Client Scope: SingleItem Layout.Placeholders.Feature.Client: /sitecore/layout/Placeholder Settings/Feature/Client Scope: ItemAndChildren Content.Tenant.Client: /sitecore/content/Client Scope: SingleItem Push operations: CreateAndUpdate Content.Site.Client: /sitecore/content/Client/Client-website Rules: 13 FieldsFilter Excludes: 0 Roles: 0 Users: 0 ---- Example of explain: PS D:\Git\Client\dxp-sitecoreai> dotnet sitecore ser explain -p "/sitecore/content/Client/Client-website/Presentation/Available Renderings" [_Client.Main] [/sitecore/content/Client/Client-website] Rule /Presentation/Available Renderings with scope ItemAndDescendants included item [_Client.Main] [/sitecore/content/Client/Client-website] Rule /Presentation/Available Renderings set allowed push operations CreateUpdateAndDelete [_Client.Main] [/sitecore/content/Client/Client-website] Path /sitecore/content/Client/Client-website/Presentation/Available Renderings of master database is included! Physical path: D:\Git\Client\dxp-sitecoreai\serialization\_Client.main\items\Content.Site.Client\Client-website\Presentation\Available Renderings.yml 
----- 
The tool must be visual, allowing us to leverage the session open when the dev executes a login from the CLI: dotnet sitecore cloud login --allow-write true After that the info and explain commands would be used to visually show the content tree with visual signs showing the status of the item in the serialization: 1) Items not serialized would show in gray (as if it is disabled) 2) Items that are exact matches with Includes would show as Yellow - eg: "includes": [ { "name": "System.Settings.Project.Client", "path": "/sitecore/system/Settings/Project/Client", "scope": "itemAndDescendants", "allowedPushOperations": "CreateUpdateAndDelete", "database": "master" }, 3) Items that are indirectly serialized due to a parent direct item are shown in orange
